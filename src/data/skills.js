...
export const SKILLS = [
  { id: 'attack', name: 'Attack', icon: '⚔️', color: '#9c2b1f', combat: true },
  { id: 'hitpoints', name: 'Hitpoints', icon: '❤️', color: '#9c2b1f', combat: true, startLevel: 10 },
  { id: 'mining', name: 'Mining', icon: '⛏️', color: '#6f7a8a' },
  { id: 'strength', name: 'Strength', icon: '💪', color: '#1f7a3a', combat: true },
  { id: 'defence', name: 'Defence', icon: '🛡️', color: '#2f6fdb', combat: true },
