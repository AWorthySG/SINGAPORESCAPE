...
export const ABILITIES = [
  { id: 'power_strike', name: 'Power Strike', key: 'Z', icon: '💥', cost: 25, cd: 4, kind: 'attack',
    dmgMul: 1.9, guaranteed: true, desc: 'A guaranteed, devastating blow (~1.9x damage).' },
  { id: 'flurry', name: 'Flurry', key: 'X', icon: '🌀', cost: 35, cd: 6, kind: 'attack',
    hits: 3, dmgMul: 0.65, desc: 'Strike three rapid times in a single turn.' },
  { id: 'brace', name: 'Brace', key: 'C', icon: '🛡️', cost: 20, cd: 5, kind: 'guard',
    guardTicks: 4, reduce: 0.5, desc: 'Halve incoming damage for 4 ticks — counter heavy blows.' },
  { id: 'second_wind', name: 'Second Wind', key: 'V', icon: '💚', cost: 60, cd: 12, kind: 'heal',
    healFrac: 0.25, desc: 'Recover a quarter of your life in an instant.' },
];
