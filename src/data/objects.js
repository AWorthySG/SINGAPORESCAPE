...
export const OBJECTS = {
  // ---------------- Trees ----------------
  tree: {
    name: 'Tree', type: 'tree', verb: 'Chop down', emoji: '🌳', blocking: true,
  ...
  oak: {
    name: 'Oak tree', type: 'tree', verb: 'Chop down', emoji: '🌳', blocking: true,
    skill: 'woodcutting', level: 15, tool: 'axe', gives: 'oak_logs', xp: 37.5,
    lowChance: 0.25, highChance: 0.80, depleteChance: 0.125, respawn: 14,
    examine: 'A grand old oak.',
  },
  willow: {
    name: 'Willow tree', type: 'tree', verb: 'Chop down', emoji: '🌳', blocking: true,
    ...
    examine: 'Its branches droop into the water.',
  },

  // ---------------- Rocks ----------------
  copper_rock: {
    name: 'Copper rock', type: 'rock', verb: 'Mine', emoji: '🪨', blocking: true,
  ...
  tin_rock: {
    name: 'Tin rock', type: 'rock', verb: 'Mine', emoji: '🪨', blocking: true,
  ...
  iron_rock: {
    name: 'Iron rock', type: 'rock', verb: 'Mine', emoji: '🪨', blocking: true,
    ...
    examine: 'A rock containing iron.',
  },
  coal_rock: {
    name: 'Coal rock', type: 'rock', verb: 'Mine', emoji: '🪨', blocking: true,
    skill: 'mining', level: 30, tool: 'pickaxe', gives: 'coal', xp: 50,
    lowChance: 0.25, highChance: 0.80, depleteChance: 1, respawn: 10, ore: '#2a2a2a',
    examine: 'A rock containing coal.',
  },

  // ---------------- Fishing ----------------
  fishing_spot: {
    name: 'Fishing spot', type: 'fishing', verb: 'Net', emoji: '🎣', blocking: false,
    skill: 'fishing', tool: 'net', depleteChance: 0, respawn: 0,
    // Level-gated catches; first eligible-by-level entry is rolled.
    catches: [
    ...
    examine: 'You see fish darting about.',
  },
