...
export const OBJECTS = {
  ...
  rod_spot: {
    ...
    catches: [
      ...
      { id: 'raw_speckled_temensis', level: 45, xp: 110, lowChance: 0.16, highChance: 0.56, weight: 26 },
      { id: 'raw_eel', level: 38, xp: 85, lowChance: 0.18, highChance: 0.62, weight: 30 },
      { id: 'raw_peacock_bass', level: 32, xp: 80, lowChance: 0.22, highChance: 0.68, weight: 40 },
      { id: 'raw_pike', level: 25, xp: 60, lowChance: 0.25, highChance: 0.74, weight: 50 },
      { id: 'raw_marble_goby', level: 24, xp: 70, lowChance: 0.20, highChance: 0.60, weight: 30 },
      { id: 'raw_trout', level: 20, xp: 50, lowChance: 0.28, highChance: 0.82, weight: 60 },
  ...
  sea_rod_spot: {
    ...
    catches: [
      ...
      { id: 'raw_hybrid_grouper', level: 62, xp: 160, lowChance: 0.12, highChance: 0.48, weight: 20 },
      { id: 'raw_diamond_trevally', level: 58, xp: 150, lowChance: 0.14, highChance: 0.52, weight: 26 },
      { id: 'raw_longfin_trevally', level: 50, xp: 125, lowChance: 0.16, highChance: 0.58, weight: 34 },
      { id: 'raw_tenggiri', level: 48, xp: 120, lowChance: 0.18, highChance: 0.60, weight: 40 },
      { id: 'raw_golden_snapper', level: 40, xp: 105, lowChance: 0.20, highChance: 0.64, weight: 40 },
      { id: 'raw_red_drum', level: 38, xp: 100, lowChance: 0.22, highChance: 0.66, weight: 50 },
      { id: 'raw_mangrove_jack', level: 34, xp: 92, lowChance: 0.24, highChance: 0.70, weight: 60 },
      { id: 'raw_barramundi', level: 30, xp: 88, lowChance: 0.26, highChance: 0.72, weight: 70 },
